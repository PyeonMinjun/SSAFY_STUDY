...
class Qdata {
    ...
    public Qdata(int x, int y, int d) {
        this.x = x;
        this.y = y;
        this.d = d;
    }
...
//            }
            ...
            for (int i = 0; i < 4; i++) {
                ...
                // 만약 잔디라면
                if (mapData[nx][ny].equals("G")) {
                    vis[nx][ny] = true;
                    q.add(new Qdata(nx, ny, i));
                }
            }
